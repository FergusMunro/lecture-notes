...
\begin{definition} $ $
  \begin{itemize}
    \item $c \in D$ is called a {\bf local maximum point} of $f : D \rightarrow \mathbb{R}$ if there exists $\delta > 0$ such that for all $x \in D$ with $0 < |x - c| < \delta$ we have
    \[f(x) \leq f(c).\]
\item $c \in D$ is called a {\bf local minimum point} of $f : D \rightarrow \mathbb{R}$ if there exists a $\delta > 0$ such that for all $x \in D$ with $0 < |x - c| < \delta$ we have
    \[f(c) \leq f(x).\]
  \end{itemize}
\end{definition}
