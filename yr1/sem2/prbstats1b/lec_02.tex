...
\begin{definition}
    ...
    \[h(t) = \lim_{\delta t \rightarrow 0} \frac{1}{\delta t} \mathbb{P}(X \in (t, t + \delta t) | X > t).\]

    This can be viewed as the instantaneous rate of survival... % TODO: go over this

    If $X$ is continuous, then
    \[\mathbb{P}(X \in (t, t + \delta t)) = f_x(t).\]
