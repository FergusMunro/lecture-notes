...
\noindent We can calculate that $\Gamma(1) = 1$, and hence we can show that for positive integers
\[\Gamma(t) = (t - 1) !.\]
...
\begin{prop}
    If $X_1,...,X_k$ are independent variables where $X_i \sim Exp(\lambda)$, then
